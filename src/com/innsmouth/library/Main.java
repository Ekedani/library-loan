...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/innsmouth/library/view/users/add_user.fxml"));
    ...
    private AddUserController createController(Stage stage) {
        return new AddUserController(createFacade(), stage);
    }
